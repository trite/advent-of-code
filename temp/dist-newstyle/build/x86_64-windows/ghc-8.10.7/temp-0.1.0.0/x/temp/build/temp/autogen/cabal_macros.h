...
/* package temp-0.1.0.0 */
#ifndef VERSION_temp
#define VERSION_temp "0.1.0.0"
#endif /* VERSION_temp */
#ifndef MIN_VERSION_temp
#define MIN_VERSION_temp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_temp */
...
#define CURRENT_COMPONENT_ID "temp-0.1.0.0-inplace-temp"
